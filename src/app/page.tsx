...
export default function DashboardPage() {
  ...
  const templatesDb: Record<string, TemplateData> = {
    'CSC & Online Services': {
      ...
      subheadline: 'उत्पन्न, जात, डोमिसाइल दाखले, नवीन पॅन कार्ड, पीएम किसान नोंदणी, ई-श्रम, पासपोर्ट आणि सर्व भरती फॉर्म्स त्वरित भरून मिळतील.',
      heroImage: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=800&auto=format&fit=crop&q=80',
      phone: '9876543210',
      ...
      services: [
        { title: 'सर्व सरकारी दाखले (Certificates)', desc: 'उत्पन्न दाखला, रहिवासी, जात प्रमाणपत्र, नॉन क्रिमीलेयर आणि गॅझेट नोंदणी.', price: '₹१०० पासून' },
      ...
      stats: [
        ...
        { label: 'सरकारी योजना लाभार्थी', value: '५,०००+' },
        { label: 'समाधानी नागरिक', value: '१००%' }
      ],
      testimonials: [
        { name: 'सचिन कांबळे', review: 'उत्पन्नाचा दाखला अवघ्या २ दिवसांत काढून मिळाला. खूपच तत्पर सेवा!', rating: 5 },
        { name: 'ज्ञानेश्वर माने', review: 'लाडकी बहीण योजनेचा फॉर्म कोणत्याही त्रुटीशिवाय भरून दिला. धन्यवाद CSC केंद्र!', rating: 5 }
      ]
    },
    'Mobile & Electronics': {
  ...
  const handleGenerateWebsite = () => {
    ...
    setTimeout(() => {
      ...
      } else if (lower.includes('mobile') || lower.includes('मोबाईल') || lower.includes('फोन') || lower.includes('smartphone') || lower.includes('इलेक्ट्रॉनिक्स')) {
      ...
      if (matchedKey && templatesDb[matchedKey]) {
        ...
        const dynamicSite: TemplateData = {
          ...
          businessName: `${customTitle.toUpperCase()} प्रिमियम केंद्र`,
          tagline: `${customTitle} ची विश्वासार्ह आणि तत्पर सेवा`,
          headline: `${customTitle} वर मिळवा थेट विशेष डिस्काउंट आणि सर्वोत्तम गॅरंटी!`,
          subheadline: `आमच्याकडे सर्व प्रकारच्या आधुनिक सुविधा आणि दर्जेदार सेवा वाजवी दरात उपलब्ध आहेत. आजच संपर्क करा.`,
          heroImage: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=800&auto=format&fit=crop&q=80',
          phone: '9876543210',
          email: 'support@businessgrowth.com',
          address: 'मुख्य चौक, बाजारपेठ, सांगली',
          timing: 'सकाळी ९:०० ते रात्री ९:००',
          primaryCta: 'इन्स्टंट ऑफर मिळवा',
          badge: '★ AI प्रमाणित ५-स्टार बिझनेस',
          services: [
            { title: `${customTitle} प्रिमियम पॅकेज`, desc: 'सर्वोत्तम दर्जा, विश्वासार्ह मार्गदर्शन आणि १००% समाधान.', price: '₹४९९ पासून' },
            { title: 'इन्स्टंट डोअरस्टेप सर्व्हिस', desc: 'कमीत कमी वेळेत अचूक व खात्रीशीर सेवा.', price: 'बेस्ट प्राईस' },
            { title: 'विशेष ग्राहक डिस्काउंट', desc: 'पहिल्या १०० ग्राहकांसाठी विशेष सवलत योजना.', price: '२०% सूट' }
          ],
          stats: [
            { label: 'हॅपी ग्राहक', value: '५,०००+' },
            { label: 'विश्वासार्हता', value: '१००%' },
            { label: 'गुगल रेटिंग', value: '५.० ★' }
          ],
          testimonials: [
            { name: 'सचिन कांबळे', review: 'उत्कृष्ट सेवा आणि अतिशय नम्र संभाषण. सर्वांनी नक्की भेट द्या!', rating: 5 },
            { name: 'प्रियांका शिंदे', review: 'काम खूप जलद आणि अचूक झाले. ५-स्टार अनुभव!', rating: 5 }
          ]
        };
        setSelectedTemplate('Custom AI Generated');
